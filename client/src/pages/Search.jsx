    ...
    <div className="page">
      ...
      <form onSubmit={handleSearch}>
        <div className="search-area-row">
          ...
          <button
            type="submit"
            className="btn btn-primary search-area-button"
          >
            Search
          </button>
        </div>
